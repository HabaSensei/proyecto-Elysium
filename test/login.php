		...
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login">
					<input type="text"  name="nombre-login" placeholder="Escribe tu Usuario" required=""/>
					<input type="password" name="clave-login" placeholder="Escribe tu Contraseña" required=""/>
					<div class="forgot">
						<a href="#">Perdida de Contraseña?</a>
						
					</div>
					 <p>¿Cómo iniciaras sessión?</p>
                  <div class="radio">
                    <label>
			...
			<a href="registered.html"><h4 style="color='#D89C27;' " >Crear Cuenta Nueva</h4></a>
